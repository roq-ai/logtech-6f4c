...
import { getAccessKeyById } from 'apiSdk/access-keys';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Access Key Detail View
          </Text>
          {hasAccess('access_key', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/access-keys/edit/${data?.id}`} passHref legacyBehavior>
              <Button
